...
특히나 Android 진영에서는 Kotlin은 필수처럼 여겨집니다.
...
**아무도 얘기해주지 않는 코틀린 도입을 미뤄야 할 3가지 이유**를 소개해보고자 합니다.<br/><br/><br/>
...
Java코드를 Kotlin에 붙여넣는다고 동작하지는 않습니다.<br/>
...
![why_not]({{ "/assets/img/post/20201213_03.jpeg" | relative_url}})
...
하지만 적어도 제가 알아봤던 국내 코드 취약점 분석 솔루션 제공업체들은 늦어도 올 하반기에는 제공예정이라고 밝혔었습니다.<br/>
그것이 어렵다면 아래와 같이 오픈소스 분석 툴을 사용하는 것도 방법이 될 수 있습니다. 

- [Detekt](https://github.com/detekt/detekt) : 오픈소스 Kotlin 정적 분석 툴

물론 보안상의 기준은 상용 솔루션에 비하면 낮은 편이지만 오픈소스인걸 고려하면 도입은 충분히 검토해볼만 합니다.<br/>
...
[if Kakao 2018 에서 발표](https://tv.kakao.com/channel/3150758/cliplink/391419295)한 내용을 참고하자면 실제로 성능이 거의 동일하다고 합니다.
