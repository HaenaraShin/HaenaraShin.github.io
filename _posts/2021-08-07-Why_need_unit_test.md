...
그렇다고 UI 테스트가 있으니까 Unit 테스트가 필요없다는 것은 아닙니다. <br/>
<br/>
...
테스트코드가 많다는 것은 리팩토링 했을 때 수정되어야 할 코드 역시 많다는 의미가 됩니다.<br/>
...
3개월 후의 내가 코드를 까먹어도 예상 결과를 확인할 수 있습니다. <br/>
...
그러나 코드의 구조와 생산성과 신뢰성 측면만 보더라도 충분히 단위테스트를 짜는 데 의미가 있습니다.<br/>
